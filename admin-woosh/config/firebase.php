        ...
        'app' => [
            ...
            'credentials' => env('FIREBASE_CREDENTIALS')
                ? (str_starts_with(env('FIREBASE_CREDENTIALS'), '/') || str_contains(env('FIREBASE_CREDENTIALS'), ':')
                    ? env('FIREBASE_CREDENTIALS')                          // path absolut
                    : base_path(env('FIREBASE_CREDENTIALS')))              // path relatif → jadikan absolut
            ...
            'firestore' => [
                ...
                /*
                 * Use REST transport instead of gRPC (required when ext-grpc is not installed).
                 * Pass keyFilePath so FirestoreClient can authenticate independently.
                 */
                'client_config' => [
                    'transport'   => 'rest',
                    'keyFilePath' => env('FIREBASE_CREDENTIALS')
                        ? (file_exists(base_path(env('FIREBASE_CREDENTIALS')))
